...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    config.default_solr_params = {
    	:qf => 'desc_metadata__title_info_title_tesim desc_metadata__title_info_sub_title_tesim desc_metadata__title_info_non_sort_tesim',
      :qt => 'search',
      :rows => 10
    }
    ...
    config.index.title_field = 'desc_metadata__title_info_0_title_tesim'
    ...
    config.add_facet_field solr_name('desc_metadata__subject_topic', :facetable), :label => 'Topic'
    config.add_facet_field solr_name('desc_metadata__location_physical_location', :facetable), :label => 'Location'
    ...
    config.add_index_field solr_name('desc_metadata__title_info_0_title', :stored_searchable, type: :string), :label => 'Title'
    ...
    config.add_search_field('title') do |field|
      ...
      field.solr_local_parameters = {
        :qf => 'desc_metadata__title_info_title_tesim',
        :pf => '$title_pf'
      }
    end
